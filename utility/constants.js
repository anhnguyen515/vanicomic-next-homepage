export const BRAND_NAME = "Vanicomic";
export const OG_TITLE = "Vanicomic";

export const RECAPTCHA_PUBLIC_KEY =
  process.env.NEXT_PUBLIC_RECAPTCHA_PUBLIC_KEY;

export const FACEBOOK_PAGE_URL = "https://www.facebook.com/vanicomic/";
export const TWITTER_URL = "https://twitter.com/vanicomic/";
